...
#line 75 "foreign-dl-parser.y"
{
  long int integer;
  igraph_real_t real;
}
/* Line 187 of yacc.c.  */
#line 187 "foreign-dl-parser.c"
	YYSTYPE;
...
static const yytype_uint8 yyrline[] =
{
     ...
     110,   110,   112,   112,   114,   115,   116,   119,   120,   124,
     124,   129,   129,   131,   141,   143,   145,   145,   147,   149,
     153,   158,   162,   164,   165,   166,   167,   168,   171,   172,
     175,   177,   181,   184,   185,   188,   190,   194,   197,   213,
     215,   216,   217,   218,   219,   222,   223,   226,   228,   231,
     231,   237,   238,   241,   243,   247,   247
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 99 "foreign-dl-parser.y"
    { igraph_i_dl_data.n=(yyvsp[(3) - (7)].integer); }
    break;

  case 7:
#line 105 "foreign-dl-parser.y"
    { igraph_i_dl_data.type=IGRAPH_DL_MATRIX; }
    break;

  case 8:
#line 106 "foreign-dl-parser.y"
    { igraph_i_dl_data.type=IGRAPH_DL_EDGELIST1; }
    break;

  case 9:
#line 107 "foreign-dl-parser.y"
    { igraph_i_dl_data.type=IGRAPH_DL_NODELIST1; }
    break;
...
#line 153 "foreign-dl-parser.y"
  ...
  case 31:
#line 158 "foreign-dl-parser.y"
    { }
    break;

  case 32:
#line 162 "foreign-dl-parser.y"
    {}
    break;
...
#line 172 "foreign-dl-parser.y"
  ...
  case 40:
#line 175 "foreign-dl-parser.y"
    {
                     igraph_i_dl_add_edge_w((yyvsp[(1) - (4)].integer)-1, (yyvsp[(2) - (4)].integer)-1, (yyvsp[(3) - (4)].real)); }
    break;

  case 41:
#line 177 "foreign-dl-parser.y"
    {
		     igraph_i_dl_add_edge((yyvsp[(1) - (3)].integer)-1, (yyvsp[(2) - (3)].integer)-1);
}
    break;

  case 42:
#line 181 "foreign-dl-parser.y"
    { (yyval.integer)=igraph_pajek_get_number(igraph_dl_yytext, 
					  igraph_dl_yyleng); }
    break;
...
#line 188 "foreign-dl-parser.y"
    {
                            igraph_i_dl_add_edge_w((yyvsp[(1) - (4)].integer), (yyvsp[(2) - (4)].integer), (yyvsp[(3) - (4)].real)); }
    break;

  case 46:
#line 190 "foreign-dl-parser.y"
    {
			  igraph_i_dl_add_edge((yyvsp[(1) - (3)].integer), (yyvsp[(2) - (3)].integer));
 }
    break;

  case 47:
#line 194 "foreign-dl-parser.y"
    { (yyval.real)=igraph_pajek_get_number(igraph_dl_yytext, 
					  igraph_dl_yyleng); }
    break;
...
#line 197 "foreign-dl-parser.y"
  ...
  igraph_trie_get2(&igraph_i_dl_data.trie, igraph_dl_yytext, 
		   igraph_dl_yyleng, &(yyval.integer));
 }
    break;

  case 49:
#line 213 "foreign-dl-parser.y"
    {}
    break;

  case 50:
#line 215 "foreign-dl-parser.y"
    {}
    break;

  case 51:
#line 216 "foreign-dl-parser.y"
    {}
    break;
...
#line 217 "foreign-dl-parser.y"
  ...
  case 53:
#line 218 "foreign-dl-parser.y"
    {}
    break;

  case 54:
#line 219 "foreign-dl-parser.y"
    {}
    break;

  case 55:
#line 222 "foreign-dl-parser.y"
    {}
    break;

  case 56:
#line 223 "foreign-dl-parser.y"
    {}
    break;

  case 57:
#line 226 "foreign-dl-parser.y"
    {}
    break;

  case 58:
#line 228 "foreign-dl-parser.y"
    { igraph_i_dl_data.from=igraph_pajek_get_number(igraph_dl_yytext,
							  igraph_dl_yyleng); }
    break;
...
#line 231 "foreign-dl-parser.y"
  ...
  IGRAPH_CHECK(igraph_vector_push_back(&igraph_i_dl_data.edges, 
				       igraph_i_dl_data.from-1)); 
  IGRAPH_CHECK(igraph_vector_push_back(&igraph_i_dl_data.edges, (yyvsp[(2) - (2)].integer)-1));
 }
    break;
...
#line 243 "foreign-dl-parser.y"
    {
  igraph_i_dl_data.from=(yyvsp[(1) - (1)].integer);
 }
    break;

  case 66:
#line 247 "foreign-dl-parser.y"
    {
  IGRAPH_CHECK(igraph_vector_push_back(&igraph_i_dl_data.edges, 
				       igraph_i_dl_data.from));
  IGRAPH_CHECK(igraph_vector_push_back(&igraph_i_dl_data.edges, (yyvsp[(2) - (2)].integer)));
 }
    break;


/* Line 1267 of yacc.c.  */
#line 1830 "foreign-dl-parser.c"
      default: break;
    }
